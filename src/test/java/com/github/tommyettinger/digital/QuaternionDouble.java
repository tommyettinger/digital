...
public class QuaternionDouble {
	...
	public QuaternionDouble(float x, float y, float z, float w) {
		this.set(x, y, z, w);
	}
	...
	public QuaternionDouble(Vector3 axis, float angle) {
		this.set(axis, angle);
	}
	...
	public QuaternionDouble set (float x, float y, float z, float w) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.w = w;
	 ...
	 * @param angle The angle in degrees
	 * @return This quaternion for chaining. */
	public QuaternionDouble set (Vector3 axis, float angle) {
	...
	public QuaternionDouble setEulerAngles (float yaw, float pitch, float roll) {
	 ...
	 * @return this quaternion */
	public QuaternionDouble setEulerAnglesRad (float yaw, float pitch, float roll) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionDouble mul (final float x, final float y, final float z, final float w) {
	 ...
	 * @param w the w component of the other quaternion to multiply with
	 * @return This quaternion for chaining */
	public QuaternionDouble mulLeft (final float x, final float y, final float z, final float w) {
	...
	/** Add the x,y,z,w components of the passed in quaternion to the ones of this quaternion */
	public QuaternionDouble add (float qx, float qy, float qz, float qw) {
		this.x += qx;
		this.y += qy;
		this.z += qz;
		this.w += qw;
...
// method
	 ...
	 * @return This quaternion for chaining. */
	public QuaternionDouble setFromAxis (final Vector3 axis, final float degrees) {
	 ...
	 * @return This quaternion for chaining. */
	public QuaternionDouble setFromAxisRad (final Vector3 axis, final float radians) {
	 ...
	 * @param degrees The angle in degrees
	 * @return This quaternion for chaining. */
	public QuaternionDouble setFromAxis (final float x, final float y, final float z, final float degrees) {
	 ...
	 * @param radians The angle in radians
	 * @return This quaternion for chaining. */
	public QuaternionDouble setFromAxisRad (final float x, final float y, final float z, final float radians) {
	...
	public QuaternionDouble setFromAxes (float xx, float xy, float xz, float yx, float yy, float yz, float zx, float zy, float zz) {
	 ...
	 * @param zy z-axis y-coordinate
	 * @param zz z-axis z-coordinate */
	public QuaternionDouble setFromAxes (boolean normalizeAxes, float xx, float xy, float xz, float yx, float yy, float yz, float zx,
										 float zy, float zz) {
		if (normalizeAxes) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionDouble setFromCross (final float x1, final float y1, final float z1, final float x2, final float y2,
										  final float z2) {
	 ...
	 * @return this quaternion for chaining */
	public QuaternionDouble slerp (QuaternionDouble end, float alpha) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionDouble slerp (QuaternionDouble[] q, float[] w) {
	 ...
	 * @return This quaternion for chaining */
	public QuaternionDouble exp (float alpha) {
...
// value
	...
	public float dot (final QuaternionDouble other) {
	 ...
	 * @return this quaternion for chaining. */
	public QuaternionDouble mul (float scalar) {
		this.x *= scalar;
		this.y *= scalar;
		this.z *= scalar;
		this.w *= scalar;
	...
	public void getSwingTwist (final float axisX, final float axisY, final float axisZ, final QuaternionDouble swing,
	...
	public float getAngleAroundRad (final float axisX, final float axisY, final float axisZ) {
		final float d = Vector3.dot(this.x, this.y, this.z, axisX, axisY, axisZ);
		final float l2 = QuaternionDouble.len2(axisX * d, axisY * d, axisZ * d, this.w);
