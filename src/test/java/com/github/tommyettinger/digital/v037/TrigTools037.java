 ...
 * some statistical code. TrigTools037 provides sinSmooth(), cosSmooth(), and degree/turn variants of those for when the
 ...
 */
public final class TrigTools037 {

    /**
     * Not meant to be instantiated.
     */
    private TrigTools037() {
    }
     ...
     * {@code (angle + TrigTools037.SIN_TO_COS) & TrigTools037.TABLE_MASK} (or {@code (angle + 4096) & 16383}) to get x.
    ...
    public static float tan(float radians) {
        ...
        radians *= TrigTools037.PI_INVERSE;
        radians += 0.5f;
        radians -= Math.floor(radians);
        radians -= 0.5f;
        radians *= TrigTools037.PI;
...
//        return x * ((1.0/945.0) * x4 - (1.0/9.0) * x2 + 1.0) / ((1.0/63.0) * x4 - (4.0/9.0) * x2 + 1.0);
    ...
    public static double tan(double radians) {
        radians *= TrigTools037.PI_INVERSE_D;
        radians += 0.5;
        radians -= Math.floor(radians);
        radians -= 0.5;
        radians *= TrigTools037.PI_D;
...
//        return x * ((1.0/945.0) * x4 - (1.0/9.0) * x2 + 1.0) / ((1.0/63.0) * x4 - (4.0/9.0) * x2 + 1.0);
     ...
     * outputs are possible from {@link TrigTools037#sin(float)}, and about half of those are duplicates, so if you need
    ...
    public static float sinSmooth(float radians) {
        ...
        radians = radians * (TrigTools037.PI_INVERSE * 2f);
     ...
     * outputs are possible from {@link TrigTools037#cos(float)}, and about half of those are duplicates, so if you need
    ...
    public static float cosSmooth(float radians) {
        ...
        radians = radians * (TrigTools037.PI_INVERSE * 2f) + 1f;
        final int ceil = (int) Math.ceil(radians) & -2;
        radians -= ceil;
        final float x2 = radians * radians, x3 = radians * x2;
        return (((11 * radians - 3 * x3) / (7 + x2)) * (1 - (ceil & 2)));
    ...
    public static double sinSmooth(double radians) {
        ...
        radians = radians * (TrigTools037.PI_INVERSE_D * 2.0);
    ...
    public static double cosSmooth(double radians) {
        //
        radians = radians * (TrigTools037.PI_INVERSE_D * 2.0) + 1.0;
        final long ceil = (long) Math.ceil(radians) & -2L;
        radians -= ceil;
        final double x2 = radians * radians, x3 = radians * x2;
        return (((11 * radians - 3 * x3) / (7 + x2)) * (1 - (ceil & 2)));
     ...
     * outputs are possible from {@link TrigTools037#sinDeg(float)}, and about half of those are duplicates, so if you need
     ...
     * outputs are possible from {@link TrigTools037#cosDeg(float)}, and about half of those are duplicates, so if you need
     ...
     * outputs are possible from {@link TrigTools037#sinTurns(float)}, and about half of those are duplicates, so if you
     ...
     * outputs are possible from {@link TrigTools037#cosTurns(float)}, and about half of those are duplicates, so if you
