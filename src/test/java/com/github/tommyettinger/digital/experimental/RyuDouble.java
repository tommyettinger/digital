...
final class RyuDouble {
    ...
    public static <T extends CharSequence & Appendable> T appendDecimal(T builder, double value) {
        return appendDecimal(builder, value, -10000);
    }

    public static <T extends CharSequence & Appendable> T appendDecimal(T appendable, double value, int lengthLimit) {
