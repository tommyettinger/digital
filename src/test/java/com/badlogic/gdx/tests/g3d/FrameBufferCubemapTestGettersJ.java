...
public class FrameBufferCubemapTestGettersJ extends Basic3DSceneTest {
	...
	protected QuaternionDoubleJ quat;

	@Override
	public void create () {
		super.create();

		quat = new QuaternionDoubleJ();
//		quat = new Quaternion();
	...
	public static void main(String[] args){
		...
		new Lwjgl3Application(new FrameBufferCubemapTestGettersJ(), config);
	}
}
