...
// This is a prototype before submitting a PR to libGDX; almost all the work was done by Antz.
...
public class Vector4 implements Serializable, Vector<Vector4>  {
    ...
    private static final long serialVersionUID = 1542325009675084157L;
    ...
    /** Creates a vector from the given vector and z and w -component
     *
     * @param vector The vector
     * @param z The z-component
     * @param w The w-component */
    ...
    /** Sets the components of the given vector2 and z and w - component
     *
     * @param vector The vector
     * @param z The z-component
     * @param w The w-component
    ...
    public Vector4 setToRandomDirection () {
        // The algorithm here is #19 at https://extremelearning.com.au/how-to-generate-uniformly-random-points-on-n-spheres-and-n-balls/ .
     ...
     * Strings with this exact format can be parsed with {@link #fromString(String)}.
