...
package com.badlogic.gdx.utils2;
...
public class BitsOther {
	...
	public void and (BitsOther other) {
	 ...
	 *
	 * @param other a bit set */
	public void andNot (BitsOther other) {
	 ...
	 * value true.
	 * @param other a bit set */
	public void or (BitsOther other) {
		int commonWords = Math.min(bits.length, other.bits.length);
		for (int i = 0; commonWords > i; i++) {
			bits[i] |= other.bits[i];
		}
	 ...
	 * </ul>
	 * @param other */
	public void xor (BitsOther other) {
		int commonWords = Math.min(bits.length, other.bits.length);
	...
	public boolean intersects (BitsOther other) {
		long[] bits = this.bits;
	...
	public boolean containsAll (BitsOther other) {
		long[] bits = this.bits;
		long[] otherBits = other.bits;
